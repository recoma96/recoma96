...
🟢 진행 중
> Trailine 서비스에서 사용할 위치 데이터를 수집하기 위한 Android 기반 어플리케이션
* GPS 기반 우치 데이터 및 현장 정보 수집
...
⏸️ PinLog 완료 후 개발 재개
> 등산 및 트레킹 정보 제공과 GPX 기반 루트 설계를 지원하는 웹 서비스
* 코스 정보 및 난이도 제공
* 사용자 맞춤 루트 편집
* PinLog에서 수집한 데이터 활용
...
* **Expanding**: Typescript, NestJS, PostgreSQL, React(Web, Native)
